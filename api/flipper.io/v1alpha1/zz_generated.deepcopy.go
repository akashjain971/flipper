...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlipperMatch) DeepCopyInto(out *FlipperMatch) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FlipperMatch.
func (in *FlipperMatch) DeepCopy() *FlipperMatch {
	if in == nil {
		return nil
	}
	out := new(FlipperMatch)
	in.DeepCopyInto(out)
	return out
}
